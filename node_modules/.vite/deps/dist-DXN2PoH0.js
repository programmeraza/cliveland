...
import { AttributeTokenList, Attributes, DEFAULT_RATE as DEFAULT_RATE$1, DEFAULT_RATES, Document, GlobalThis, MediaChromeButton, MediaStateChangeEvents, MediaStateReceiverAttributes, MediaUIAttributes, MediaUIEvents, areSubsOn, camelCase, closestComposedNode, containsComposedNode, formatTextTrackObj, getActiveElement, getAttributeMediaController, getDocumentOrShadowRoot, getMediaController, getNumericAttr, getStringAttr, insertCSSRule, isNumericString, media_controller_default, media_error_dialog_default, namedNodeMapToObject, observeResize, parseAudioTrackList, parseRenditionList, parseTextTracksStr, setNumericAttr, setStringAttr, stringifyTextTrackList, t, unobserveResize } from "./dist-BpDDXMyG.js";
import { Hls } from "./hls-D5TwzBRY.js";
import { CustomVideoElement, MediaTracksMixin } from "./dist-CC2Mjspa.js";
...
var TemplateInstance = class extends GlobalThis.DocumentFragment {
	constructor(template, state, processor$1 = defaultProcessor) {
		...
		(_a$1 = processor$1.createCallback) == null || _a$1.call(processor$1, this, __privateGet$7(this, _parts), state);
...
var Directives = {
	...
	if: (part, state) => {
		...
		} else (_a$1 = templateInstances.get(part)) == null || _a$1.update(state);
		else {
			part.replace("");
...
var processor = { processCallback(instance, parts, state) {
	...
	for (const [expression, part] of parts) {
		if (part instanceof InnerTemplatePart) {
			...
			(_a$1 = Directives[part.directive]) == null || _a$1.call(Directives, part, state);
			continue;
		}
...
var operators = {
	...
	"|": (a$2, b$4) => {
		var _a$1;
		return (_a$1 = pipeModifiers[b$4]) == null ? void 0 : _a$1.call(pipeModifiers, a$2);
	}
};
...
var MediaThemeElement = class extends GlobalThis.HTMLElement {
	constructor() {
		...
		const observer = new MutationObserver((mutationList) => {
			var _a$1;
			if (this.mediaController && !((_a$1 = this.mediaController) == null ? void 0 : _a$1.breakpointsComputed)) return;
	...
	get template() {
		var _a$1;
		return (_a$1 = __privateGet$6(this, _template)) != null ? _a$1 : this.constructor.template;
	}
	set template(value) {
		if (value === null) {
	...
	get props() {
		var _a$1, _b, _c;
		const observedAttributes = [...Array.from((_b = (_a$1 = this.mediaController) == null ? void 0 : _a$1.attributes) != null ? _b : []).filter(({ name }) => {
	...
	render() {
		var _a$1;
		(_a$1 = this.renderer) == null || _a$1.update(this.props);
	}
};
...
updateTemplate_fn = function() {
	...
	const template = (_a$1 = rootNode == null ? void 0 : rootNode.getElementById) == null ? void 0 : _a$1.call(rootNode, templateId);
	if (template) {
...
function getRectRelativeToOffsetParent(element, offsetParent) {
	...
	const offsetRect = (_a$1 = offsetParent == null ? void 0 : offsetParent.getBoundingClientRect()) != null ? _a$1 : {
		x: 0,
		y: 0
	};
	return {
...
var MediaChromeMenu = class extends GlobalThis.HTMLElement {
	...
	connectedCallback() {
		...
		(_b = (_a$1 = __privateGet$5(this, _mediaController)) == null ? void 0 : _a$1.associateElement) == null || _b.call(_a$1, this);
		if (!this.hidden) {
	...
	disconnectedCallback() {
		...
		this.disable();
		(_b = (_a$1 = __privateGet$5(this, _mediaController)) == null ? void 0 : _a$1.unassociateElement) == null || _b.call(_a$1, this);
	...
	*/
	get anchorElement() {
		var _a$1;
		if (this.anchor) return (_a$1 = getDocumentOrShadowRoot(this)) == null ? void 0 : _a$1.querySelector(`#${this.anchor}`);
		return null;
	}
	/**
	...
	*/
	...
	get value() {
		var _a$1, _b;
		return (_b = (_a$1 = this.checkedItems[0]) == null ? void 0 : _a$1.value) != null ? _b : "";
	}
	set value(newValue) {
	...
	handleSelect(event) {
		...
		if (__privateGet$5(this, _invokerElement) && !this.hidden) {
			(_a$1 = __privateGet$5(this, _previouslyFocused)) == null || _a$1.focus();
			this.hidden = true;
		}
	}
	get keysUsed() {
	...
	handleMove(event) {
		...
		const currentItem = (_b = (_a$1 = __privateMethod$5(this, _getItem, getItem_fn).call(this, event)) != null ? _a$1 : __privateMethod$5(this, _getTabItem, getTabItem_fn).call(this)) != null ? _b : items[0];
...
updateLayoutStyle_fn = function() {
	...
	const menuLayout = (_a$1 = getComputedStyle(this).getPropertyValue("--media-menu-layout")) == null ? void 0 : _a$1.trim();
...
handleOpen_fn = function() {
	var _a$1;
	(_a$1 = __privateGet$5(this, _invokerElement)) == null || _a$1.setAttribute("aria-expanded", "true");
...
handleClosed_fn = function() {
	var _a$1;
	(_a$1 = __privateGet$5(this, _invokerElement)) == null || _a$1.setAttribute("aria-expanded", "false");
	unobserveResize(getBoundsElement(this), __privateGet$5(this, _handleBoundsResize));
	unobserveResize(this, __privateGet$5(this, _handleMenuResize));
};
...
backButtonElement_get = function() {
	var _a$1;
	return (_a$1 = this.shadowRoot.querySelector("slot[name=\"header\"]").assignedElements({ flatten: true })) == null ? void 0 : _a$1.find((el) => el.matches("button[part~=\"back\"]"));
};
...
handleFocusOut_fn = function(event) {
	...
	if (!containsComposedNode(this, event.relatedTarget)) {
		if (__privateGet$5(this, _isPopover)) (_a$1 = __privateGet$5(this, _previouslyFocused)) == null || _a$1.focus();
...
function getBoundsElement(host) {
	var _a$1;
	return (_a$1 = host.getAttribute("bounds") ? closestComposedNode(host, `#${host.getAttribute("bounds")}`) : getMediaController(host) || host.parentElement) != null ? _a$1 : host;
}
...
var MediaChromeMenuItem = class extends GlobalThis.HTMLElement {
	constructor() {
		...
		*/
		__privateAdd$4(this, _handleMenuItem, () => {
			...
			const checkedItem = (_a$1 = this.submenuElement.checkedItems) == null ? void 0 : _a$1[0];
	...
	*/
	get invokeTargetElement() {
		var _a$1;
		if (this.invokeTarget) return (_a$1 = getDocumentOrShadowRoot(this)) == null ? void 0 : _a$1.querySelector(`#${this.invokeTarget}`);
	...
	*/
	...
	get type() {
		var _a$1;
		return (_a$1 = this.getAttribute(Attributes$2.TYPE)) != null ? _a$1 : "";
	}
	set type(val) {
	...
	get value() {
		var _a$1;
		return (_a$1 = this.getAttribute(Attributes$2.VALUE)) != null ? _a$1 : this.text;
	}
	set value(val) {
	...
	get text() {
		var _a$1;
		return ((_a$1 = this.textContent) != null ? _a$1 : "").trim();
	}
	get checked() {
...
reset_fn = function() {
	var _a$1;
	const items = (_a$1 = __privateGet$4(this, _ownerElement)) == null ? void 0 : _a$1.radioGroupItems;
	if (!items) return;
...
var MediaChromeMenuButton = class extends MediaChromeButton {
	...
	*/
	...
	handleClick() {
		var _a$1;
		(_a$1 = this.invokeTargetElement) == null || _a$1.dispatchEvent(new InvokeEvent({ relatedTarget: this }));
	}
};
...
var MediaAudioTrackMenu = class extends MediaChromeMenu {
	...
	*/
	get anchorElement() {
		var _a$1;
		if (this.anchor !== "auto") return super.anchorElement;
		return (_a$1 = getMediaController(this)) == null ? void 0 : _a$1.querySelector("media-audio-track-menu-button");
	}
	...
	*/
	get mediaAudioTrackEnabled() {
		var _a$1;
		return (_a$1 = getStringAttr(this, MediaUIAttributes.MEDIA_AUDIO_TRACK_ENABLED)) != null ? _a$1 : "";
	}
...
var MediaAudioTrackMenuButton = class extends MediaChromeMenuButton {
	...
	*/
	get invokeTargetElement() {
		var _a$1;
		if (this.invokeTarget != void 0) return super.invokeTargetElement;
		return (_a$1 = getMediaController(this)) == null ? void 0 : _a$1.querySelector("media-audio-track-menu");
	}
	/**
	* Get enabled audio track id.
	* @return {string}
...
render_fn$2 = function() {
	...
	for (const subs of subtitlesList) {
		...
		if (((_a$1 = subs.kind) != null ? _a$1 : "subs") === "captions") item2.append(createIndicator(this, "captions-indicator"));
...
var MediaCaptionsMenuButton = class extends MediaChromeMenuButton {
	...
	*/
	get invokeTargetElement() {
		var _a$1;
		if (this.invokeTarget != void 0) return super.invokeTargetElement;
		return (_a$1 = getMediaController(this)) == null ? void 0 : _a$1.querySelector("media-captions-menu");
	}
	/**
	* An array of TextTrack-like objects.
	* Objects must have the properties: kind, language, and label.
...
var MediaRenditionMenu = class extends MediaChromeMenu {
	...
	static compareRendition(a$2, b$4) {
		var _a$1, _b;
		return b$4.height === a$2.height ? ((_a$1 = b$4.bitrate) != null ? _a$1 : 0) - ((_b = a$2.bitrate) != null ? _b : 0) : b$4.height - a$2.height;
	}
	attributeChangedCallback(attrName, oldValue, newValue) {
		super.attributeChangedCallback(attrName, oldValue, newValue);
...
//# sourceMappingURL=dist-DXN2PoH0.js.map